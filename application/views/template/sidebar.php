            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="<?php echo base_url() ?>" class="site_title"><i class="fa fa-building"></i> <span>Sistema 23Kfilms</span></a>
                    </div>
                        ...
                        <div class="menu_section active">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-share-alt"></i> Movimientos <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?php echo base_url(); ?>Movimientos/Ventas"><i class="fa fa-circle-o"></i> Proyectos</a></li>
                                        <li><a href="<?php echo base_url(); ?>Movimientos/Presupuesto"><i class="fa fa-circle-o"></i> Presupuesto de proyectos</a></li>
                                    </ul>
                                </li>
