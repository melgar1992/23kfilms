                                  ...
                                  <form action="" id='editar_presupuesto' name="editar_presupuesto" method="POST" class="form-horizontal">
                                      ...
                                      <div class="form-group">
                                          <div class="col-md-3">
                                              ...
                                              <input type="number" min="0" max="60" placeholder="%" step="0.1" value="<?php echo $venta->porcentaje_honorarios; ?>" class="form-control" id="porcentaje_honorarios" name="porcentaje_honorarios" required>
                                          </div>
                                          <div class="col-md-3">
                                              <label for="honorarios">Honorarios Agencia:</label>
                                              <input type="number" min="0" max="60" placeholder="%" step="0.1" value="<?php echo $venta->porcentaje_honorarios_agencia; ?>" class="form-control" id="porcentaje_honorarios_agencia" name="porcentaje_honorarios_agencia" required>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-3">
                                              <div class="input-group has-feedback">
                                                  ...
                                                  <input type="text" class="form-control" value="<?php echo $venta->sub_total ?>" placeholder="" id="sub_total" value="0.00" name="sub_total" readonly="readonly">
                                                  <span class="fa fa-dollar form-control-feedback right" aria-hidden="true"></span>
                                              </div>
                                          </div>
                                      </div>
